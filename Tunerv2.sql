...
#Initialize a variable for sql_id
_VAR(){
        SQL_ID=frqcv71skm5rv
}

#View the plan changes of the particular sql_id 
_VIEW_PLAN_CHANGE_2()
{
...
#Tune the sql, if there is a better plan than the existing plan
_TUNE_SQL_3(){
...
#Function for creating a sql profile and pin the good plan
_TUNER_PROFILE_4(){
